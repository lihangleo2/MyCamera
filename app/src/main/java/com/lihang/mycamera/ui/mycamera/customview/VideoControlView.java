...
public class VideoControlView extends View {
     ...
     * 视频录制最长时间 秒
     */
    private static final int VIDEO_RECORD_DEFAULT_MAX_TIME = 15;
    /**
     * 视频录制最小时间 秒
     */
    private final int VIDEO_RECORD_DEFAULT_MIN_TIME = 2;
    /**
     * 视频录制内圆半径
     */
    ...
    private void initData(Context context, AttributeSet attrs) {
        ...
        a.recycle();
        //初始化外圆画笔
        mExCirclePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    private void drawProgress(Canvas canvas) {
        final RectF rectF = new RectF(
                mWidth / 2 - (mInnerCircleRadius + (mExCircleRadius - mInnerCircleRadius) - 10),
                mHeight / 2 - (mInnerCircleRadius + (mExCircleRadius - mInnerCircleRadius) - 10),
                mWidth / 2 + (mInnerCircleRadius + (mExCircleRadius - mInnerCircleRadius) - 10),
                mHeight / 2 + (mInnerCircleRadius + (mExCircleRadius - mInnerCircleRadius) - 10));

//        final RectF rectF = new RectF(
//                mWidth / 2 - mExCircleRadius +20,
//                mHeight / 2 - mExCircleRadius -20,
//                mWidth / 2  + mExCircleRadius  -20,
//                mHeight / 2 +  mExCircleRadius -20);


        canvas.drawArc(rectF, -90, mCurrentProgress, false, mProgressPaint);
        Log.e("这里呢多少呢", mInnerCircleRadius + "===========" + mExCircleRadius + "=============" + mCurrentProgress);
    }
                    ...
                    if (mEndTime - mStartTime < LONG_CLICK_MIN_TIME) {
                        ...
                        if (mProgressAni != null && mProgressAni.getCurrentPlayTime() / 1000 < mMinTime) {
                            ...
                            if (onRecordListener != null) {
                                ...
                                Log.e("运行了这里了吗", "==================0000000000000000000");
                            ...
                            if (onRecordListener != null) {
                                ...
                                Log.e("运行了这里了吗", "==================1111111111111111111");
                            }
                        }
                    }
    ...
    private void startAniProgress() {
        ...
        mProgressAni.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                mCurrentProgress = 0;
                invalidate();
                Log.i("这里应该才是走完了", "11111111111111111111");
                ...
                if (onRecordListener != null) {
                    if (mProgressAni != null && mProgressAni.getCurrentPlayTime() / 1000 >= 15) {
                        onRecordListener.OnFinish(1);
                    }
                }
            }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case VideoControlView.MSG_START_LONG_RECORD:
                    ...
                    Log.e("这里是什么鬼", videoControlView.mExCircleRadius + "=====");
                    Log.e("这里是什么鬼", videoControlView.excicleMagnification + "=====");


                    Log.e("这里是什么鬼", videoControlView.mInnerCircleRadius + "=====");
                    Log.e("这里是什么鬼", videoControlView.excicleMagnification + "=====");
